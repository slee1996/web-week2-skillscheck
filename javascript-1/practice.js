...
var total = myNumbers.reduce((x,y) => x + y)
...
var totallyAwesome = people.reduce((accumulator,currentValue) => accumulator + currentValue.awesomeLevel, 0)
